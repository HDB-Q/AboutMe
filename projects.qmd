...
## [Optimizing Admissions at EHN Canada with AI](EHN_Project.qmd)
My team and I build a Gen AI platform for EHN Canada to streamline knowledge retrieval during their admission process. We supplement our chat application with an evaluation framework, and a tool to update their knowledge bases.

<span class="badge bg-success">Large Language Model</span>
...
<span class="badge bg-success">Misc</span>

## [SQL Refresh](SQL_Overview.qmd)
A refresher page on SQL commands including CTEs, Partition, others. 
